    ...
    Rectangle {
        ...
        Component.onCompleted:{
            if(index === 0 || index === 3 || index === 4) {
                CustomSwitch.create(_MainRect)
               var switchObj = CustomSwitch.getSwitchObj()
                switchObj.anchors.rightMargin = 40
            }
        ...
        BorderImage {
            ...
            source: icon
            width: ResizeImg.reSizeW(index); height: ResizeImg.reSizeH(index)
